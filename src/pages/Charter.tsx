...
const DIMENSIONS: Array<{
  ...
  },
  {
    ...
    name: "추세",
    icon: TrendingUp,
    examples: "ADX · EMA Ribbon",
    blurb: "방향성 강도 측정. ADX > 25 = 추세장, EMA 정렬로 멀티 TF 추세 일관성 확인.",
  },
  {
    id: 4,
    name: "거래량",
    icon: BarChart3,
    examples: "Volume Ratio · CVD",
    blurb: "참여도 + 매수/매도 압력. EMA50 baseline 대비 비율, CVD divergence 로 진위 검증.",
  },
  {
    id: 5,
    name: "구조",
    icon: Box,
    examples: "Fibonacci · Order Block",
    blurb: "가격 구조와 핵심 레벨. 피보나치 retracement + ICT/SMC order block 으로 zone 식별.",
  },
  {
    id: 6,
    name: "매크로",
    icon: BarChart3,
    examples: "SOFR · Yield · DXY · Funding · Breadth",
    blurb: "거시 유동성·금리·달러 컨텍스트. 시장 폭(breadth)+펀딩 극단치도 macro layer 로 합산.",
  },
  {
    id: 7,
    name: "온체인",
